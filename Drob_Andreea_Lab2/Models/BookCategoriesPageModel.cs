...
namespace Drob_Andreea_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Drob_Andreea_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Drob_Andreea_Lab2Context context,
